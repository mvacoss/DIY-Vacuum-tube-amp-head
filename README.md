...
* [Story](#story)
  * [Why Another vacuum tube amplifier design](#why-another-vacuum-tube-amplifier-design)
* [Schematic and circuits](#schematic-and-circuits)
  * [Inputs](#inputs)
  * [Preamplifier stage](#preamplifier-stage)
  * [Power amplifier stage](#power-amplifier-stage)
  * [Output transformer](#output-transformer)
  * [Power supply](#power-supply)
* [Mechanical construction](#mechanical-construction)
  * [Chassis](#chassis)
  * [Winding the output transformer](#winding-the-output-transformer)
...
When switched to Low-Z, the signal goes firstly through passive mixing network consisting of R2 and R3. This converts stereo signal to mono signal with equivalent series impedance of roughly 500Ω. The coupling capacitor C1 is increased to 100nF in this case. A standard 22nF cap would interact with the lower impedance to create an accidental high-pass filter; 100nF ensures full-range bass response. R5 provides a lower grid leak resistance. Since line-level signals are already pre-amplified, the circuit requires less sensitivity and benefits from the added noise rejection of a lower impedance path.
...
- Also keep an eye when buying Single pole Dual throw (SPDT) switches, I had to modify mines because when I firstly put the amp together, they had practically zero contact in both of the positions
